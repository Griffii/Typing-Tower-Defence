...
func fire(
	...
	if is_instance_valid(target_enemy):
		end_pos = target_enemy.global_position
	else:
		end_pos = from_pos
...
func _on_impact() -> void:
	...
	if is_instance_valid(target_enemy) and combat_manager != null and combat_manager.has_method("apply_tower_hit"):
